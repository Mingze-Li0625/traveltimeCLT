...
#' @export
sample_route <- function(tripID, trips, r = NULL, timeBin_x_edges = NULL, rho = 0.31, lambda = 0, abuse_ratio = 0) {
  ...
  # Filter trips based on abuse_ratio quantile
  filtered_tripID <- train_edge_count[quantile >= abuse_ratio, trip]
